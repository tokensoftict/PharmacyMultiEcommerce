...
@section('content')
    ...
    <div class="page">
        ...
        <header class="topbar" role="banner">
            <img class="topbar__logo" src="https://generaldrugcentre.com/logo/logo.png" alt="PS General Drugs Centre Logo"
                width="32" height="32">
        ...
        <main class="card-wrap" role="main">
            <article class="card" itemscope itemtype="https://schema.org/Product">
                ...
                {{-- Hero image --}}
                <div class="hero">
                    <img class="hero__img" src="{{ $viewModel->image }}" alt="{{ $viewModel->title }}" width="480"
                        height="360" loading="eager" fetchpriority="high" itemprop="image">
                ...
                <div class="body">
                    ...
                    <div class="cta-section">
                        ...
                        <div class="cta-stores">
                            <a href="{{ $viewModel->playStoreUrl }}" target="_blank" rel="noopener noreferrer"
                                class="btn btn--store btn--playstore" id="btn-playstore"
                                ...
                                <svg class="store-svg" viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
                                    <path
                                        d="M3.609 1.814L13.792 12 3.61 22.186c-.365-.365-.61-.926-.61-1.606V3.42c0-.68.245-1.241.61-1.606zM15.207 13.414l2.457-2.457-12.78-7.38 10.323 9.837zm0-2.828L4.884 20.423l12.78-7.38-2.457-2.457zm1.414 1.414l3.195 1.845c.783.452.783 1.189 0 1.641l-3.195 1.845-2.043-2.043 2.043-2.043z" />
                                </svg>
                            ...
                            <a href="{{ $viewModel->appStoreUrl }}" target="_blank" rel="noopener noreferrer"
                                class="btn btn--store btn--appstore" id="btn-appstore"
