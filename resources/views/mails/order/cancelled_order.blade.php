                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                            <tr>
                                <td bgcolor="#ffffff" align="left" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                                    ...
                                    <p align="center" style="margin: 10px;">We wanted to inform you that your order #{{ $order->order_id }} has been canceled.</p>
                                    <p align="center" style="margin: 10px;">If this was unexpected or if you need further assistance, please don’t hesitate to contact our support team—we’re happy to help! 💙</p>
                                    <br/>
                                    <p align="center" style="margin: 10px;">Thank you for choosing. We hope to serve you again soon!</p>
                                </td>
                            </tr>
                            <tr>
