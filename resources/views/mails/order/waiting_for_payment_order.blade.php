                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                            <tr>
                                <td bgcolor="#ffffff" align="left" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                                    ...
                                    <p align="center" style="margin: 10px;">Your order #{{ $order->order_id }} is now packed and ready for you! 🎉</p>
                                    <p align="center">Since you’ve chosen to <b>{{ $order->delivery_method->name }}</b>, we’re just waiting for you to complete the payment so we can proceed. Please visit us at your convenience to finalize your order.</p>
                                    <p align="center">If you have any questions, feel free to reach out. We’re here to help! 😊</p>
                                    <p align="center">Looking forward to seeing you soon!</p>
                                    <br/>
                                    <p align="center"   style="margin: 10px;">Thanks for your patronage!</p>
                                </td>
                            </tr>
                            <tr>
