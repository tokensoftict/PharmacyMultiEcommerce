                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                            ...
                            <tr>
                                <td bgcolor="#ffffff" align="left" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                                    ...
                                    <p align="center" style="margin: 10px;">We encountered an issue while processing your order #{{ $order->order_id }} this could be due to an item being out of stock or a system error.</p>
                                    <p align="center" style="margin: 10px;">But don’t worry! 😊 Our customer care team is already looking into it and will fix it as soon as possible. We’ll update you shortly.</p>
                                    <p  align="center" style="margin: 10px;">If you have any questions, feel free to reach out to our support team. Thanks for your patience! 💙</p>
                                    <br/>
