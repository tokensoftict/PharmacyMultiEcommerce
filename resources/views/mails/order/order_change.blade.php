                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                            <tr>
                                <td bgcolor="#ffffff" align="left" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                                    ...
                                    <p align="center" style="margin: 10px;">We have made some changes to your order #{{ $order->order_id }} items, Your order total is now <b>{{ number_format($order->total,2) }}</b></p>
                                    <p align="center" style="margin: 10px;">Your updated invoice is included in this email.</p>
                                    <p align="center" style="margin: 10px;">If you have any questions, feel free to reach out. Thank you for your patience and for shopping with us! 😊</p>
