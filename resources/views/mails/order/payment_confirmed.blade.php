                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                            <tr>
                                <td bgcolor="#ffffff" align="left" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                                    ...
                                    <p align="center" style="margin: 10px;">Great news! 🎉 We’ve received your payment for order #{{ $order->order_id }}, and everything is now confirmed. ✅</p>
                                    <p  align="center" style="margin: 10px;">Your order is now moving to the next step, and we’ll notify you once it’s out for delivery or ready for pickup. Stay tuned! 🚀</p>
                                    <p  align="center" style="margin: 10px;">If you have any questions, feel free to reach out. Thanks for shopping with us! 😊</p>
                                    <br/>
