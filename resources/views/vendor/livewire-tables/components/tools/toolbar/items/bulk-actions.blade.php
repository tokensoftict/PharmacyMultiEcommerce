...
<div
    ...
    x-cloak x-show="(selectedItems.length > 0 || alwaysShowBulkActions || selectedItems.length == 0)"
    @class([
...
>
    ...
    >
        <button
            @class([
                'btn btn-outline-info dropdown-toggle d-block d-md-inline' => $component->isBootstrap(),
