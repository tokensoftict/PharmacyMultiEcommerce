    ...
    @endif
        {{
            $attributes->merge($customAttributes)
                ...
                ->class(['align-middle text-wrap' => $component->isBootstrap() && ($customAttributes['default'] ?? true)])
                ->class(['d-none align-middle text-wrap' => $component->isBootstrap() && $column && $column->shouldCollapseAlways()])
                ->class(['d-none d-sm-table-cell align-middle text-wrap' => $component->isBootstrap() && $column && $column->shouldCollapseOnMobile()])
                ->class(['d-none d-md-table-cell align-middle text-wrap' => $component->isBootstrap() && $column && $column->shouldCollapseOnTablet()])
