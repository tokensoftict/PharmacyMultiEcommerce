...
@elseif ($component->isBootstrap())
    <th scope="col" {{
        $attributes->merge($customAttributes)
            ->class(['white-space-nowrap fs-9 align-middle ps-0' => $customAttributes['default'] ?? true])
            ->class(['d-none white-space-nowrap fs-9 align-middle ps-0' => $column->shouldCollapseAlways()])
            ->class(['d-none d-md-table-cell white-space-nowrap fs-9 align-middle ps-0' => $column->shouldCollapseOnMobile()])
            ->class(['d-none d-lg-table-cell white-space-nowrap fs-9 align-middle ps-0' => $column->shouldCollapseOnTablet()])
            ->except('default')
        }}
    >
        @if($column->getColumnLabelStatus())
