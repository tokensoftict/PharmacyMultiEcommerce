    ...
    <div class="bg-white border-l min-h-full shadow-lg border-slate-300 p-4 relative dark:bg-slate-900 dark:border-slate-800">
        ...
        @if($media)
            ...
            <div class="mt-4" id="confirmHolder">
                <button type="button" onclick="sendData('{{ getMediaFullPath($media) }}')" class="border rounded p-1.5 border-red-600 text-white bg-red-500 w-full text-white content-center rounded-lg">
                    Confirm
                </button>
            </div>
        @endif
