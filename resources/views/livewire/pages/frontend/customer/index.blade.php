...
<div x-data="landingPage()" class="relative min-h-screen w-full bg-white text-neutral-900 overflow-hidden"
    ...
    <div class="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        <div
            class="absolute top-[-10%] left-[-10%] w-[60%] h-[60%] rounded-full bg-brandRed-100/40 blur-[120px] animate-pulse-slow">
        </div>
        <div class="absolute bottom-[-10%] right-[-10%] w-[65%] h-[65%] rounded-full bg-red-100/40 blur-[130px] animate-pulse-slow"
            style="animation-delay: 2s;"></div>
        <div class="absolute top-[40%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-[50%] h-[50%] rounded-full bg-red-5/30 blur-[100px] animate-pulse-slow"
            style="animation-delay: 4s;"></div>

        <!-- Floating Accent Orbs -->
        <div
            class="absolute top-[15%] left-[20%] w-72 h-72 rounded-full bg-gradient-to-tr from-brandRed-200/30 to-red-200/20 blur-[60px] animate-orb-float-1">
        </div>
        <div
            class="absolute top-[60%] right-[15%] w-[350px] h-[350px] rounded-full bg-gradient-to-br from-red-200/25 to-rose-200/20 blur-[80px] animate-orb-float-2">
        </div>
        <div
            class="absolute bottom-[20%] left-[10%] w-80 h-80 rounded-full bg-gradient-to-tr from-rose-200/20 to-brandRed-200/30 blur-[70px] animate-orb-float-3">
        </div>

        <!-- Particle Grid Overlay -->
        <div
            class="absolute inset-0 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(220,38,38,0.08),rgba(255,255,255,0))]">
        </div>
        <div
            class="absolute inset-0 opacity-[0.02] bg-[linear-gradient(to_right,#000_1px,transparent_1px),linear-gradient(to_bottom,#000_1px,transparent_1px)] bg-[size:24px_24px]">
        </div>
    </div>
    ...
    <!-- HERO SECTION -->
    <section
        class="relative z-20 max-w-7xl mx-auto px-6 pt-12 pb-24 md:py-32 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
        <!-- Hero Text content -->
        <div class="lg:col-span-7 flex flex-col items-start hero-text">
            <!-- Promo Badge -->
            <div
                class="mb-6 inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-brandRed-200 bg-red-50 text-xs font-semibold text-brandRed-600 tracking-wide">
                <span class="flex h-2 w-2 relative">
                    <span
                        class="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75"></span>
                    <span class="relative inline-flex rounded-full h-2 w-2 bg-brandRed-600"></span>
                </span>
                Pharmacy & Supermarket App
            </div>
            ...
            <p class="text-neutral-600 text-lg md:text-xl leading-relaxed max-w-xl mb-10">
                Shop 20,000+ groceries, OTC drugs, prescription medications, provisions, and clinical supplies. Get
            ...
            <div class="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto mb-16">
                <!-- App Store -->
                <a href="https://apps.apple.com/ng/app/ps-gdc/id6741708076" target="_blank"
                    class="relative w-full sm:w-56 group overflow-hidden bg-black text-white py-4 px-6 rounded-2xl flex items-center justify-center gap-3 shadow-xl hover:scale-[1.03] active:scale-[0.98] transition-all duration-300">
                    <i data-lucide="apple" class="w-7 h-7 fill-white"></i>
                    <div class="text-left">
                        <div class="text-[10px] uppercase font-bold tracking-wider opacity-60 leading-none">Download on
                            the</div>
                ...
                <!-- Google Play -->
                <a href="https://play.google.com/store/apps/details?id=com.tokensoftict.psgdc&hl=en_GB" target="_blank"
                    class="relative w-full sm:w-56 group overflow-hidden bg-neutral-900 text-white py-4 px-6 rounded-2xl flex items-center justify-center gap-3 shadow-xl hover:scale-[1.03] active:scale-[0.98] transition-all duration-300">
                    <svg class="w-6 h-6 fill-white" viewBox="0 0 24 24">
                        <path
                            d="M5,3.14L15.3,13.43L5,23.73C4.6,23.53 4.3,23.13 4.3,22.6V4.28C4.3,3.75 4.6,3.34 5,3.14M16.71,14.85L19.46,16.43C20.15,16.83 20.15,17.7 19.46,18.1L16.71,19.68L14.16,17.13L16.71,14.85M5.72,2.5L16,12.78L13.43,15.35L5.72,2.5M16,13.07L18.75,14.65C19.44,15.05 19.44,15.92 18.75,16.32L16,17.9L13.72,15.62L16,13.07Z" />
                    </svg>
                    <div class="text-left">
                        <div class="text-[10px] uppercase font-bold tracking-wider opacity-60 leading-none">Get it on
                        </div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-6 md:gap-10 border-t border-neutral-100 pt-10 w-full text-left"
                id="hero-stats">
                <div>
                    <div class="text-3xl md:text-4xl font-extrabold text-neutral-900" x-text="stats.downloads + 'k+'">
                        0k+</div>
                    <div class="text-neutral-500 text-xs mt-1 uppercase tracking-wider font-semibold">Downloads</div>
                </div>
                <div>
                    <div class="text-3xl md:text-4xl font-extrabold text-neutral-900" x-text="stats.products + 'k+'">0k+
                    </div>
                ...
                <div>
                    ...
                    <div
                        class="text-neutral-500 text-xs mt-1 uppercase tracking-wider font-semibold flex items-center gap-1">
                        Rating <i data-lucide="star" class="w-3.5 h-3.5 fill-amber-500 text-amber-500"></i>
                    </div>
                </div>
                <div>
                    <div class="text-3xl md:text-4xl font-extrabold text-neutral-900" x-text="stats.satisfaction + '%'">
                        0%</div>
        ...
        <div
            class="lg:col-span-5 relative h-[500px] sm:h-[650px] w-full flex items-center justify-center perspective-[1500px] hero-mockups">
            <!-- iOS Mockup (Front) - Product Catalog -->
            <div
                class="absolute z-30 transform -rotate-y-[15deg] rotate-x-[5deg] hover:rotate-y-[5deg] hover:scale-[1.03] transition-all duration-700 ease-out translate-x-[-15%] sm:translate-x-[-25%] translate-y-[-5%]">
                <div
                    class="w-[240px] h-[480px] sm:w-[280px] sm:h-[560px] rounded-[48px] p-3 bg-neutral-950 border-[6px] border-neutral-800 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.3)] relative overflow-hidden ring-1 ring-white/10">
                    <!-- Notch -->
                    <div
                        class="absolute top-0 left-1/2 -translate-x-1/2 w-36 h-6 bg-neutral-950 rounded-b-2xl z-50 flex items-center justify-between px-5 py-1">
                    ...
                    <div class="w-full h-full rounded-[38px] bg-[#0C0C0E] overflow-hidden relative select-none">
                        <img src="{{ asset('logo/interface1.png') }}" alt="PSGDC Store Interface"
            ...
            <div
                class="absolute z-20 transform rotate-y-[15deg] rotate-x-[5deg] hover:rotate-y-[5deg] hover:scale-[1.03] transition-all duration-700 ease-out translate-x-[25%] translate-y-[8%] opacity-80 hover:opacity-100">
                <div
                    class="w-[230px] h-[460px] sm:w-[270px] sm:h-[540px] rounded-[44px] p-3 bg-neutral-950 border-[6px] border-neutral-800 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.3)] relative overflow-hidden ring-1 ring-white/10">
                    <div
                        class="absolute top-4 left-1/2 -translate-x-1/2 w-3.5 h-3.5 rounded-full bg-neutral-950 z-50 ring-2 ring-neutral-800">
                    </div>
                    <!-- Screen App Content -->
                    <div class="w-full h-full rounded-[34px] bg-[#0A0A0B] overflow-hidden relative select-none">
                        <img src="{{ asset('logo/interface2.png') }}" alt="PSGDC Prescription Upload Interface"
                            class="w-full h-full object-cover">
                    </div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div class="lg:col-span-7 space-y-6">
                ...
                <p class="text-neutral-600 text-base leading-relaxed">
                    PSGDC Pharmacy (PS General Drugs Centre) was established and incorporated in 2020. Our core store is
                    situated at 1 Lajorin junction, Muritala Mohammed way, Ilorin, Kwara state.
                </p>
                <p class="text-neutral-600 text-base leading-relaxed">
                    We manage a dedicated team of over 50 professionals, including registered pharmacists, trained
                    warehouse logistics personnel, and assistants. We specialize in the bulk and retail distribution of
                    ethical drugs, OTCs, injectables, cooling chain items, surgical equipment, and imported UK
                    groceries.
                </p>
                <div class="p-6 rounded-3xl bg-neutral-50 border border-neutral-200/60 space-y-4">
                    ...
                    <p class="text-xs text-neutral-500 leading-relaxed pl-9">
                        Our inventory holds over 3,000 NAFDAC registered and verified pharmaceutical products to
                        guarantee authentic medical outcomes.
                    </p>
                </div>
            </div>
            ...
            <div class="lg:col-span-5 space-y-6">
                <div
                    class="glass-card rounded-[32px] p-8 space-y-6 glow-border shadow-sm bg-gradient-to-br from-red-50/30 to-rose-50/20">
                    <h4 class="text-xs uppercase font-extrabold tracking-wider text-neutral-500">Manufacturing
                        Connection</h4>
                    <div class="flex gap-4 items-center">
                        <div
                            class="w-12 h-12 rounded-2xl bg-red-100 flex items-center justify-center text-brandRed-600">
                    ...
                    <p class="text-xs text-neutral-605 leading-relaxed">
                        PSGDC operates as a direct distribution subsidiary of Peace Standard Pharmaceutical Industries
                        Ltd. This connection links our inventory directly to a state-of-the-art manufacturing arm
                        formulating over 50 quality pharmaceutical products.
                    </p>
                </div>
                ...
                <div class="glass-card rounded-[32px] p-8 space-y-4 glow-border shadow-sm">
                    ...
                    <p class="text-xs text-neutral-605 leading-relaxed">
                        Promoting healthcare accessibility, security, and affordability across Kwara state and Nigeria
                        at large.
                    </p>
                </div>
            </div>
            ...
            <div class="lg:col-span-5 space-y-6">
                <div class="glass-card rounded-3xl p-8 space-y-6 shadow-sm">
                    <div class="flex items-start gap-4">
                        <div
                            class="w-10 h-10 rounded-xl bg-red-50 flex items-center justify-center text-brandRed-600 flex-shrink-0">
                ...
                <form class="space-y-6" @submit.prevent="alert('Thank you for contacting PSGDC Pharmacy!')">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" required
                                class="w-full px-4 py-3 rounded-xl border border-neutral-200 focus:outline-none focus:border-brandRed-600 text-sm">
                        </div>
                        <div>
                    ...
                    <div>
                        ...
                        <textarea rows="4" required
                            class="w-full px-4 py-3 rounded-xl border border-neutral-200 focus:outline-none focus:border-brandRed-600 text-sm resize-none"></textarea>
                    </div>
                    <button type="submit"
                        class="w-full bg-brandRed-600 hover:bg-brandRed-700 text-white text-xs font-bold uppercase tracking-wider py-4 rounded-xl shadow-lg shadow-brandRed-600/20 transition-all">
                        Send Message
                    </button>
                </form>
            </div>
    ...
    <section id="download" class="relative z-20 max-w-6xl mx-auto px-6 py-24 cta-section">
        <div
            class="glass-card rounded-[40px] p-8 md:p-20 text-center relative overflow-hidden glow-border shadow-sm bg-gradient-to-tr from-brandRed-50/50 to-rose-50/50">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4 max-w-md mx-auto">
                <a href="https://apps.apple.com/ng/app/ps-gdc/id6741708076" target="_blank"
                    class="w-full sm:w-52 py-3.5 px-6 rounded-2xl bg-black text-white font-extrabold flex items-center justify-center gap-3 shadow-md hover:scale-[1.03] active:scale-[0.98] transition-transform duration-200">
                    <i data-lucide="apple" class="w-6 h-6 fill-white"></i>
                    <span>App Store</span>
                </a>
                <a href="https://play.google.com/store/apps/details?id=com.tokensoftict.psgdc&hl=en_GB" target="_blank"
                    class="w-full sm:w-52 py-3.5 px-6 rounded-2xl bg-neutral-900 text-white font-extrabold flex items-center justify-center gap-3 shadow-md hover:scale-[1.03] active:scale-[0.98] transition-all duration-200">
    ...
    <footer class="relative z-20 border-t border-neutral-200 bg-neutral-50">
        <div class="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div>
                ...
                <ul class="space-y-2.5 text-xs text-neutral-605">
                    <li><a href="#about-us" class="hover:text-black transition-colors duration-200 font-medium">About
                            Us</a></li>
                    <li><a href="#contact-us"
                            class="hover:text-black transition-colors duration-200 font-medium">Contact Us</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2.5 text-xs text-neutral-605 mb-6">
                    <li><a href="/coupon-terms" class="hover:text-black transition-colors duration-200">Terms of
                            Service</a></li>
                    <li><a href="#privacy-policy" class="hover:text-black transition-colors duration-200">Privacy
                            Policy</a></li>
                </ul>
                <div class="flex gap-4">
                    <a href="#"
                        class="w-8 h-8 rounded-lg bg-neutral-200/50 hover:bg-neutral-200 flex items-center justify-center text-neutral-500 hover:text-black transition-colors">
        ...
        <div
            class="max-w-7xl mx-auto px-6 py-6 border-t border-neutral-200 flex flex-col sm:flex-row items-center justify-between gap-4 text-[10px] text-neutral-500">
