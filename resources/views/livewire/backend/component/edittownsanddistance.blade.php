            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button"
                                onclick="window.dispatchEvent(new CustomEvent('closeEditTownsAndDistanceModal'))"
                    ...
                    <div class="modal-footer ">
                        ...
                        <button type="button" class="btn btn-danger"
                                onclick="window.dispatchEvent(new CustomEvent('closeEditTownsAndDistanceModal'))">Cancel
                        </button>
                    </div>
                </div>
            </div>
