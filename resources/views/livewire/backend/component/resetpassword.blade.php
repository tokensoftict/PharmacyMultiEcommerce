...
<div>
    <div  wire:ignore.self class="modal fade" id="reset-password-component" tabindex="-1" role="dialog" aria-hidden="true">
        <form method="post" wire:submit.prevent="performResetPassword">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        Reset Password
                        <button type="button" onclick="window.dispatchEvent(new CustomEvent('closeResetPasswordModal'))" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        </button>
                    </div>
                            ...
                            <div class="col-12" id="modal-holder">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group mt-2">
                                        <input type="text" class="form-control" id="password" wire:model="password" placeholder="Password">
                                ...
                                <div class="form-check form-switch mt-5">
                                    <input class="form-check-input" id="flexSwitchCheckDefault" wire:model="sendPasswordToEmail" type="checkbox">
                                    <label class="form-check-label" for="flexSwitchCheckDefault">Send password to user's mailbox</label>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer ">
                        <button type="submit" wire:target="performResetPassword" wire:loading.attr="disabled" class="btn btn-phoenix-primary">
                            <span wire:loading wire:target="performResetPassword" class="spinner-border spinner-border-sm me-2" role="status"></span>
                            Reset Password
                        </button>
                        <button type="button" wire:target="performResetPassword" wire:loading.attr="disabled" class="btn btn-phoenix-danger" onclick="window.dispatchEvent(new CustomEvent('closeResetPasswordModal'))" data-dismiss="modal" aria-label="Close">Cancel</button>
                    </div>
                </div>
            </div>
        </form>
