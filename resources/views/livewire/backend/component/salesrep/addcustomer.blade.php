            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                            ...
                            <div class="col-12" id="modal-holder">
                                <div class="mb-3">
                                    ...
                                    <div class="wd-md-100p" id="addCustomer_select2_parent">
                                        <x-dropdown-select-menu placeholder="Search For Customers" wire:model="customers" id="customers" :ajax="route('utilities.user.wholesales.search')"/>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer ">
                        <button type="submit" wire:target="addCustomer" wire:loading.attr="disabled" class="btn btn-phoenix-primary">
                            <span wire:loading wire:target="addCustomer" class="spinner-border spinner-border-sm me-2" role="status"></span>
                            Add Customer
                        </button>
                        <button type="button" wire:target="addCustomer" wire:loading.attr="disabled" class="btn btn-phoenix-danger" onclick="window.dispatchEvent(new CustomEvent('closeAddCustomerModal'))" data-dismiss="modal" aria-label="Close">Cancel</button>
                    </div>
                </div>
