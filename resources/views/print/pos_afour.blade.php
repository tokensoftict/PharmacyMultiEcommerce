...
<div id="printbox">
            ...
            <td width="40%">
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td align="right" width="50%">{{ $order->orderStatus->name }}</td>
                    </tr>
                </table>
            </td>
            <td width="20%"></td>
    ...
    <br/>
    @endif
    <h2 style="margin-top:0" class="text-center">Order Item(s)</h2>
    <table id="products" style="width: 100%;">
        <tr class="product_row">
            <td  width="5%" align="center">#</td>
            <td align="left" width="50%"><b>Name</b></td>
            <td align="center"  width="5%"><b>Qty</b></td>
            <td align="center"  width="20%"><b>Rate</b></td>
        ...
        @foreach($order->orderProducts()->get() as $item)
            <tr>
                ...
                <td align="center" class="text-center">{{ number_format($item->price,2) }}</td>
                <td align="right" class="text-right">{{ number_format($item->total,2) }}</td>
            </tr>
            @php
                $num++;
            @endphp
        ...
        <tfoot>
        @foreach($order->orderTotalOrders()->get() as $item)
            <tr>
                <td></td>
                <td></td>
                <td></td>
                <th  align="right" class="text-right">{{ str_replace('Subtotal','Sub Total',$item->name) }}</th>
                <th  align="right" class="text-right">{{ number_format($item->value,2) }}</th>
            </tr>
        @endforeach
        <tr>
            <td></td>
            <td></td>
            <td></td>
            <th   align="right" class="text-right">Total Paid</th>
            <th  align="right" class="text-right"><b>{{ number_format(($order->total),2) }}</b></th>
        </tr>
        </tfoot>
    </table>
