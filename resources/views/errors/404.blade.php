        ...
        tailwind.config = {
            ...
            theme: {
                extend: {
                    ...
                    animation: {
                        'orb-float-1': 'floatOrb1 15s infinite alternate ease-in-out',
                        'orb-float-2': 'floatOrb2 20s infinite alternate ease-in-out',
                        'orb-float-3': 'floatOrb3 12s infinite alternate ease-in-out',
                    },
                    keyframes: {
                        floatOrb1: {
    ...
    <div class="z-10 w-full max-w-xl px-6">
        <div class="glass-card glow-border rounded-3xl p-8 md:p-12 shadow-2xl text-center flex flex-col items-center">
            ...
            <div class="relative mb-6">
                <h1 class="text-9xl font-black text-transparent bg-clip-text bg-gradient-to-br from-brandRed-600 to-red-400 leading-none select-none">404</h1>
            ...
            <!-- Descriptive Text -->
            <h2 class="text-2xl font-bold text-neutral-800 mb-3 mt-4">Oops! You've wandered off track</h2>
            ...
            <div class="flex flex-col sm:flex-row gap-4 w-full justify-center">
                <a href="/" class="flex items-center justify-center gap-2 px-6 py-3 bg-brandRed-600 hover:bg-brandRed-700 text-white font-medium rounded-xl transition duration-200 shadow-lg shadow-brandRed-600/20 active:scale-95">
                    <i data-lucide="home" class="w-4 h-4"></i>
                    Back to Home
                </a>
                <button onclick="window.history.back()" class="flex items-center justify-center gap-2 px-6 py-3 bg-white hover:bg-neutral-50 text-neutral-700 border border-neutral-200 font-medium rounded-xl transition duration-200 active:scale-95">
            ...
            <div class="mt-10 pt-8 border-t border-neutral-100 w-full">
                <span class="text-xs text-neutral-400 uppercase tracking-wider block mb-4">Or try one of these</span>
                <div class="flex flex-wrap justify-center gap-x-6 gap-y-2 text-sm">
                    <a href="/shop" class="text-brandBlue-600 hover:text-brandBlue-700 font-medium hover:underline flex items-center gap-1">
                        <i data-lucide="shopping-bag" class="w-3.5 h-3.5"></i> Shop Products
                    </a>
                    <a href="/contact" class="text-neutral-600 hover:text-neutral-900 font-medium hover:underline flex items-center gap-1">
