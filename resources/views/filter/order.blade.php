...
<form  method="get" class="row">
    <div class="col-5">
        ...
        <input class="form-control" name="startDate" value="{{ request()->get('startDate', date('Y-m-01'))  }}" type="date" placeholder="From">
    </div>
    <div class="col-5">
        <label class="form-label" for="inputName2">To</label>
        <input class="form-control" name="stopDate"  value="{{  request()->get('stopDate', date('Y-m-t')) }}" type="date" placeholder="To">
    </div>
