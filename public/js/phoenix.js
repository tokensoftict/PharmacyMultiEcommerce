(function (global, factory) {
  ...
  const basicEchartsInit = () => {
    ...
    document.querySelectorAll("[data-echarts]").forEach((r) => {
      ...
      echartSetOption(i, a, () => ({
        color: t("primary"),
        tooltip: { trigger: "item", padding: [7, 10], backgroundColor: t("body-highlight-bg"), borderColor: t("border-color"), textStyle: { color: t("light-text-emphasis") }, borderWidth: 1, transitionDuration: 0 },
        xAxis: {
          type: "category",
  ...
  function createNumberInput(e, t) {
    ...
    if ((-1 === navigator.userAgent.indexOf("MSIE 9.0") ? (r.type = "number") : ((r.type = "text"), (r.pattern = "\\d*")), void 0 !== t)) for (var i in t) r.setAttribute(i, t[i]);
          ...
          if ("today" === m) (i = new Date()), (n = !0);
            ...
            for (var d = void 0, v = [], g = 0, c = 0, l = ""; g < f.length; g++) {
              ...
              if (tokenRegex[D] && !x) {
                ...
                h && (d = !0) && v["Y" !== D ? "push" : "unshift"]({ fn: revFormat[D], val: h[++c] });
              } else p || (l += ".");
            }
  ...
  function FlatpickrInstance(e, t) {
    var n = { config: __assign(__assign({}, defaults), flatpickr.defaultConfig), l10n: english };
    function a() {
      var e;
      ...
      (function (e) {
        ...
        if (void 0 !== i.value && 2 === i.value.length) {
          var f = i === n.hourElement,
              u = i === n.minuteElement;
          d < o ? ((d = r + d + int(!f) + (int(f) && int(!n.amPM))), u && p(void 0, -1, n.hourElement)) : d > r && ((d = i === n.hourElement ? d - r - int(!n.amPM) : o), u && p(void 0, 1, n.hourElement)),
    ...
    function s(e, t, a) {
      ...
      n.minuteElement &&
      !n.isMobile &&
      ((n.hourElement.value = pad(n.config.time_24hr ? e : ((12 + e) % 12) + 12 * int(e % 12 == 0))),
    ...
    function h(e, t, a, i) {
      ...
      return (
          ...
          -1 === e.indexOf("hidden") && 0 === compareDates(t, n.now) && ((n.todayDateElem = r), r.classList.add("today"), r.setAttribute("aria-current", "date")),
              o
                  ? ((r.tabIndex = -1),
                  X(t) &&
                  ...
                  "range" === n.config.mode &&
                  (toggleClass(r, "startRange", n.selectedDates[0] && 0 === compareDates(t, n.selectedDates[0], !0)),
    ...
    function y() {
      if (!(n.config.showMonths > 1 || "dropdown" !== n.config.monthSelectorType)) {
        var e = function (e) {
          return (
              !(void 0 !== n.config.minDate && n.currentYear === n.config.minDate.getFullYear() && e < n.config.minDate.getMonth()) &&
              !(void 0 !== n.config.maxDate && n.currentYear === n.config.maxDate.getFullYear() && e > n.config.maxDate.getMonth())
          );
        };
    ...
    function w() {
      ...
      n.config.showMonths > 1 || "static" === n.config.monthSelectorType
          ...
          : ((n.monthsDropdownContainer = createElement("select", "flatpickr-monthDropdown-months")),
      ...
      n.config.maxDate && (o.setAttribute("max", n.config.maxDate.getFullYear().toString()), (o.disabled = !!n.config.minDate && n.config.minDate.getFullYear() === n.config.maxDate.getFullYear()));
      var r = createElement("div", "flatpickr-current-month");
      return r.appendChild(e), r.appendChild(i), a.appendChild(r), t.appendChild(a), { container: t, yearElement: o, monthElement: e };
    }
    function E() {
    ...
    function x(e, t) {
      ...
      ((n.currentMonth += a), (n.currentMonth < 0 || n.currentMonth > 11) && ((n.currentYear += n.currentMonth > 11 ? 1 : -1), (n.currentMonth = (n.currentMonth + 12) % 12), Q("onYearChange"), y()), M(), Q("onMonthChange"), z());
    }
    function T(e) {
    ...
    function I(e) {
      if (n.isOpen && !n.config.inline) {
        ...
        i &&
        o &&
        (n.config.allowInput && n.setDate(n._input.value, !1, n.config.altInput ? n.config.altFormat : n.config.dateFormat),
      ...
      if (!(!e || (n.config.minDate && e < n.config.minDate.getFullYear()) || (n.config.maxDate && e > n.config.maxDate.getFullYear()))) {
        ...
        (n.currentYear = t || n.currentYear),
            n.config.maxDate && n.currentYear === n.config.maxDate.getFullYear()
                ...
                : n.config.minDate && n.currentYear === n.config.minDate.getFullYear() && (n.currentMonth = Math.max(n.config.minDate.getMonth(), n.currentMonth)),
      ...
      if (13 === t.keyCode && o) {
        ...
        switch (t.keyCode) {
          ...
          case 40:
            ...
            (n.daysContainer && void 0 !== i.$i) || i === n.input || i === n.altInput
                ? t.ctrlKey
                    ? (t.stopPropagation(), O(n.currentYear - g), C(D(1), 0))
                    : f || C(void 0, 7 * g)
                : i === n.currentYearElement
                    ? O(n.currentYear - g)
                    : n.config.enableTime && (!f && n.hourElement && n.hourElement.focus(), r(t), n._debouncedChange());
            break;
          case 9:
            if (f) {
    ...
    function Y(e, t) {
      if ((void 0 === t && (t = "flatpickr-day"), 1 === n.selectedDates.length && (!e || (e.classList.contains(t) && !e.classList.contains("flatpickr-disabled"))))) {
        for (
          ...
          S(new Date(d), !0) || ((l = l || (d > o && d < r)), d < i && (!c || d > c) ? (c = d) : d > i && (!s || d < s) && (s = d));
    ...
    function j(e) {
      return function (t) {
        ...
        n.selectedDates.length || "min" !== e || c(a),
            Z()),
        n.daysContainer &&
        (B(), void 0 !== a ? (n.currentYearElement[e] = a.getFullYear().toString()) : n.currentYearElement.removeAttribute(e), (n.currentYearElement.disabled = !!i && void 0 !== a && i.getFullYear() === a.getFullYear()));
      };
    }
    function H() {
        ...
        if (void 0 !== n.calendarContainer) {
          ...
          if ((toggleClass(n.calendarContainer, "arrowTop", !d), toggleClass(n.calendarContainer, "arrowBottom", d), !n.config.inline)) {
            var u = window.pageXOffset + c.left,
                m = !1,
                g = !1;
            "center" === l ? ((u -= (i - c.width) / 2), (m = !0)) : "right" === l && ((u -= i - c.width), (g = !0)),
    ...
    function Q(e, t) {
      if (void 0 !== n.config) {
        var a = n.config[e];
        if (void 0 !== a && a.length > 0) for (var i = 0; a[i] && i < a.length; i++) a[i](n.selectedDates, n.input.value, n, t);
    ...
    function z() {
      ...
      (n.yearElements.forEach(function (e, t) {
        ...
        a.setMonth(n.currentMonth + t),
            n.config.showMonths > 1 || "static" === n.config.monthSelectorType
                ? (n.monthElements[t].textContent = monthToStr(a.getMonth(), n.config.shorthandCurrentMonth, n.l10n) + " ")
        ...
        (function () {
          (n.element = n.input = e),
              ...
              (function () {
                ...
                (n.input._type = n.input.type),
                    ...
                    (n._input = n.input),
                n.config.altInput &&
                ((n.altInput = createElement(n.input.nodeName, n.config.altInputClass)),
                    (n._input = n.altInput),
          ...
          (function () {
            ...
            if (((n.calendarContainer = createElement("div", "flatpickr-calendar")), (n.calendarContainer.tabIndex = -1), !n.config.noCalendar)) {
              ...
              n.daysContainer || ((n.daysContainer = createElement("div", "flatpickr-days")), (n.daysContainer.tabIndex = -1)),
                  M(),
            ...
            e.appendChild(
                (function () {
                  ...
                  var t = createElement("span", "flatpickr-time-separator", ":"),
                      a = createNumberInput("flatpickr-hour", { "aria-label": n.l10n.hourAriaLabel });
                  n.hourElement = a.getElementsByTagName("input")[0];
                  var i = createNumberInput("flatpickr-minute", { "aria-label": n.l10n.minuteAriaLabel });
                  ...
                  n.config.time_24hr ||
                  ((n.amPM = createElement("span", "flatpickr-am-pm", n.l10n.amPM[int((n.latestSelectedDateObj ? n.hourElement.value : n.config.defaultHour) > 11)])),
            ...
            if (
                ...
                n.config.inline &&
                (!o && n.element.parentNode ? n.element.parentNode.insertBefore(n.calendarContainer, n._input.nextSibling) : void 0 !== n.config.appendTo && n.config.appendTo.appendChild(n.calendarContainer)),
                    n.config.static)
            ) {
            ...
            n.config.static || n.config.inline || (void 0 !== n.config.appendTo ? n.config.appendTo : window.document.body).appendChild(n.calendarContainer);
              ...
              (function () {
                ...
                f(window.document, "focus", I, { capture: !0 }), !0 === n.config.clickOpens && (f(n._input, "focus", n.open), f(n._input, "click", n.open));
          ...
          (n.selectedDates.length || n.config.noCalendar) && (n.config.enableTime && c(n.config.noCalendar ? n.latestSelectedDateObj : void 0), Z(!1)),
              o();
  ...
  (flatpickr.defaultConfig = {}),
      (flatpickr.l10ns = { en: __assign({}, english), default: __assign({}, english) }),
  ...
  const flatpickrInit = () => {
    ...
    document.querySelectorAll(".datetimepicker").forEach((t) => {
      ...
      flatpickr(t, {
        ...
        locale: { firstDayOfWeek: 0, shorthand: ["S", "M", "T", "W", "T", "F", "S"] },
  ...
  const handleNavbarVerticalCollapsed = () => {
    ...
    v.addEventListener(i, (e) => {
      v.blur(), document.documentElement.classList.toggle(d), t("phoenixIsNavbarVerticalCollapsed", !b);
  ...
  const swiperInit = () => {
    ...
    t.forEach((t) => {
      ...
      new window.Swiper(r, { ...n, navigation: { nextEl: o?.querySelector(".swiper-button-next"), prevEl: o?.querySelector(".swiper-button-prev") }, thumbs: { swiper: s } });
    });
  };
  ...
  const { config: config } = window.config,
      initialDomSetup = (e) => {
        ...
        e.querySelectorAll("[data-theme-control]").forEach((e) => {
          ...
          if (("phoenixNavbarVerticalStyle" === n && ("horizontal" === i || "dual-nav" === i) && e.setAttribute("disabled", !0), "checkbox" === e.type))
    ...
    initialDomSetup(n.node),
        n.on("click", (e) => {
          ...
          if (d.data("theme-control")) {
            ...
            switch (("phoenixTheme" === l && "boolean" == typeof h && (h = h ? "dark" : "light"), config.hasOwnProperty(l) && window.config.set({ [l]: h }), window.history.replaceState(null, null, window.location.pathname), l)) {
              case "phoenixTheme": {
    ...
    document.querySelectorAll(t).forEach((t) => {
      ...
      v.forEach((e) => {
        e.addEventListener(
            ...
            (t) => (
                t.preventDefault(),
                    e.classList.contains("needs-validation") && (b && p && (b.value !== p.value ? p.setCustomValidity("Invalid field.") : p.setCustomValidity("")), !e.checkValidity()) ? (S.preventDefault(), !1) : ((q += 1), null)
            )
        );
      }),
        ...
        t.addEventListener(u, (a) => {
          ...
          (S = a), s > q && v[q].dispatchEvent(y);
            ...
            t.addEventListener(w, () => {
              ...
              for (let e = 0; e < q; e += 1) m[e].classList.add("done"), e > 0 && m[e - 1].classList.add("complete");
              for (let e = q; e < m.length; e += 1) m[e].classList.remove("done"), e > 0 && m[e - 1].classList.remove("complete");
              q > m.length - 2 ? g.classList.add("d-none") : g.classList.remove("d-none"), q > 0 && q !== m.length - 1 ? f.classList.remove("d-none") : f.classList.add("d-none");
            });
      });
    });
  };
