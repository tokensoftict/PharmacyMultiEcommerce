(function (factory) {
  ...
  const newCustomersChartsInit = () => {
    ...
    if (a) {
      ...
      echartSetOption(s, r, () => ({
        ...
        series: [
          { type: "line", data: [150, 100, 300, 200, 250, 180, 250], showSymbol: !1, symbol: "circle", lineStyle: { width: 2, color: o("secondary-bg") }, emphasis: { lineStyle: { color: o("secondary-bg") } } },
          { type: "line", data: [200, 150, 250, 100, 500, 400, 600], lineStyle: { width: 2, color: o("primary") }, showSymbol: !1, symbol: "circle" },
        ],
            ...
            series: [
              {
                ...
                progress: { show: !0, roundCap: !0, width: 12, itemStyle: { shadowBlur: 0, shadowColor: "#0000" } },
                pointer: { show: !1 },
                axisLine: { roundCap: !0, lineStyle: { width: 12, color: [[1, o("primary-bg-subtle")]] } },
                axisTick: { show: !1 },
                splitLine: { show: !1 },
                axisLabel: { show: !1 },
                title: { show: !1 },
  ...
  const projectionVsActualChartInit = () => {
    const { getColor: t, getData: o, getPastDates: e } = window.phoenix.utils,
        ...
        r = e(10),
        a = [44485, 20428, 47302, 45180, 31034, 46358, 26581, 36628, 38219, 43256],
        n = [38911, 29452, 31894, 47876, 31302, 27731, 25490, 30355, 27176, 30393];
    if (i) {
      const e = o(i, "echarts"),
      ...
      echartSetOption(l, e, () => ({
        ...
        legend: {
          ...
          textStyle: { color: t("body-color"), fontWeight: 600, fontFamily: "Nunito Sans" },
        },
        xAxis: {
          type: "category",
          axisLabel: { color: t("secondary-color"), formatter: (t) => window.dayjs(t).format("MMM DD"), interval: 3, fontFamily: "Nunito Sans", fontWeight: 600, fontSize: 12.8 },
          data: r,
        ...
        yAxis: {
          ...
          axisLine: { show: !1 },
          axisLabel: { fontFamily: "Nunito Sans", fontWeight: 600, fontSize: 12.8, color: t("secondary-color"), margin: 20, verticalAlign: "bottom", formatter: (t) => `$${t.toLocaleString()}` },
        },
        series: [
          { name: "Projected revenue", type: "bar", barWidth: "6px", data: n, barGap: "30%", label: { show: !1 }, itemStyle: { borderRadius: [2, 2, 0, 0], color: t("primary") } },
          { name: "Actual revenue", type: "bar", data: a, barWidth: "6px", barGap: "30%", label: { show: !1 }, z: 10, itemStyle: { borderRadius: [2, 2, 0, 0], color: t("info-bg-subtle") } },
        ],
      ...
      returningCustomerChartInit = () => {
        ...
        if (e) {
          ...
          echartSetOption(r, i, () => ({
            ...
            legend: {
              data: [
                { name: "Fourth time", icon: "roundRect", itemStyle: { color: t("primary-light"), borderWidth: 0 } },
                { name: "Third time", icon: "roundRect", itemStyle: { color: t("info-lighter"), borderWidth: 0 } },
                { name: "Second time", icon: "roundRect", itemStyle: { color: t("primary"), borderWidth: 0 } },
              ],
              right: "right",
              width: "100%",
              itemWidth: 16,
            ...
            xAxis: {
              ...
              axisTick: { show: !1 },
              axisLabel: { showMinLabel: !1, showMaxLabel: !1, color: t("secondary-color"), formatter: (t) => t.slice(0, 3), fontFamily: "Nunito Sans", fontWeight: 600, fontSize: 12.8 },
              splitLine: { show: !0, lineStyle: { color: t("secondary-bg"), type: "dashed" } },
            },
            yAxis: {
              type: "value",
              boundaryGap: !1,
              axisLabel: { showMinLabel: !0, showMaxLabel: !0, color: t("secondary-color"), formatter: (t) => `${t}%`, fontFamily: "Nunito Sans", fontWeight: 600, fontSize: 12.8 },
            ...
            series: [
              {
                ...
                lineStyle: { type: "dashed", width: 1, color: t("primary-light") },
            ...
            series: [
              {
                ...
                label: { show: !0, position: "center", formatter: "{a}", fontSize: 23, color: e("light-text-emphasis") },
                data: [
    ...
    if (e) {
      ...
      echartSetOption(i, a, () => ({
        ...
        xAxis: {
          ...
          axisLine: { show: !0, lineStyle: { color: o("secondary-bg") } },
          axisTick: { show: !1 },
          axisLabel: { formatter: (o) => window.dayjs(o).format("DD MMM"), interval: 6, showMinLabel: !0, showMaxLabel: !0, color: o("secondary-color") },
        },
        yAxis: { show: !1, type: "value", boundaryGap: !1 },
        series: [{ type: "bar", barWidth: "5px", data: [120, 200, 150, 80, 70, 110, 120], showBackground: !0, symbol: "none", itemStyle: { borderRadius: 10 }, backgroundStyle: { borderRadius: 10, color: o("primary-bg-subtle") } }],
  ...
  const totalSalesChartInit = () => {
    const { getColor: o, getData: t, getDates: e } = window.phoenix.utils,
        ...
        n = [100, 200, 300, 300, 300, 250, 200, 200, 200, 200, 200, 500, 500, 500, 600, 700, 800, 900, 1e3, 1100, 850, 600, 600, 600, 400, 200, 200, 300, 300, 300],
        r = [200, 200, 100, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 200, 400, 600, 600, 600, 800, 1e3, 700, 400, 450, 500, 600, 700, 650, 600, 550],
        s = (o) => {
          const t = window.dayjs(o[0].axisValue),
              e = window.dayjs(o[0].axisValue).subtract(1, "month"),
              a = o.map((o, a) => ({ value: o.value, date: a > 0 ? e : t, color: o.color }));
    ...
    if (a) {
      ...
      echartSetOption(l, e, () => ({
        ...
        xAxis: [
          {
            ...
            axisLine: { show: !0, lineStyle: { color: o("secondary-bg") } },
            axisTick: { show: !1 },
            splitLine: { show: !0, interval: 0, lineStyle: { color: "dark" === window.config.config.phoenixTheme ? o("body-highlight-bg") : o("secondary-bg") } },
            boundaryGap: !1,
          },
          {
            type: "category",
        ...
        yAxis: { position: "right", axisPointer: { type: "none" }, axisTick: "none", splitLine: { show: !1 }, axisLine: { show: !1 }, axisLabel: { show: !1 } },
        series: [
          { name: "d", type: "line", data: n, showSymbol: !1, symbol: "circle" },
          { name: "e", type: "line", data: r, lineStyle: { type: "dashed", width: 1, color: o("info") }, showSymbol: !1, symbol: "circle" },
        ],
      ...
      leafletTopRegionsInit = () => {
        ...
        if (L && e) {
          const e = () =>
              ...
              o = L.tileLayer.colorFilter(t, { attribution: null, transparent: !0, filter: e() }),
              a = L.map("map", { center: L.latLng(25.659195, 30.182691), zoom: 0.6, layers: [o], minZoom: 1.4 }),
              n = L.markerClusterGroup({ chunkedLoading: !1, spiderfyOnMaxZoom: !1 });
          leaftletPoints.map((e) => {
            const { name: t, location: o, street: a } = e,
                r = L.icon({
                  iconUrl:
                ...
                i = L.marker([e.lat, e.long], { icon: r }),
                A = `\n        <h6 class="mb-1">${t}</h6>\n        <p class="m-0 text-body-quaternary">${a}, ${o}</p>\n      `,
                s = L.popup({ minWidth: 180 }).setContent(A);
            return i.bindPopup(s), n.addLayer(i), !0;
          }),
              a.addLayer(n);
          document.body.addEventListener("clickControl", ({ detail: { control: e, value: t } }) => {
            "phoenixTheme" === e && o.updateFilter("dark" === t ? ["invert:98%", "grayscale:69%", "bright:89%", "contrast:111%", "hue:205deg", "saturate:1000%"] : ["bright:101%", "contrast:101%", "hue:23deg", "saturate:225%"]);
          });
        }
      };
      ...
      t.forEach((t) => {
        const l = t,
            s = {
              ...
              styles: "dark" === window.config.config.phoenixTheme ? i.SnazzyCustomDark : i.SnazzyCustomLight,
            },
            ...
            o = leaftletPoints.map((e) => {
              const { name: t, location: i, street: l } = e,
                  ...
                  o = new window.google.maps.Marker({ position: { lat: e.lat, lng: e.lng } });
              return (
                  o.addListener("click", () => {
            ...
            y = {
              render: ({ count: e, position: t }) => {
                ...
                return new window.google.maps.Marker({
                  ...
                  position: t,
                  icon: { url: `data:image/svg+xml;base64,${l}`, scaledSize: new window.google.maps.Size(45, 45) },
        ...
        return (
            e &&
            e.addEventListener("clickControl", ({ detail: { control: e, value: t } }) => {
              "phoenixTheme" === e && r.set("styles", "dark" === t ? i.SnazzyCustomDark : i.SnazzyCustomLight);
            }),
                new window.markerClusterer.MarkerClusterer({ markers: o, map: r, renderer: y })
        );
      });
    }
  };
