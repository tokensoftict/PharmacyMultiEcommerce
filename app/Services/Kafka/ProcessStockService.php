...
class ProcessStockService
{
    ...
    {
        $stockUpdate = Arr::only($data, ['local_stock_id', 'description', 'name', 'seo', 'classification_id', 'productcategory_id', 'manufacturer_id', 'productgroup_id', 'box', 'max', 'carton', 'sachet', 'is_wholesales', 'store_type']);
