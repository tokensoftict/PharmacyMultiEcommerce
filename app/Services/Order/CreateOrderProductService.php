...
class CreateOrderProductService
{
    ...
    private function formatOrderProductAttributes(array $attributes) : array
    {
        ...
        $attributes['name'] = $attributes['stock']->name;
        $attributes['model'] = $attributes['stock']->model ?? "No model";
        $attributes['quantity'] = $attributes['quantity'] ?? 1;
        $attributes['price'] = $attributes['stock']->special ?:  $attributes['stock']->{ApplicationEnvironment::$stock_model_string}->price;
