...
class ApplicationEnvironment
{
    ...
    public static function createApplicationEnvironment(App $application) : void
    {
        ...
        $requestDomain = self::parseDomain($requestDomain);
        $subdomain = Str::before($requestDomain, '.'); //wholesales-admin-staging.admin.dashboard
        if(Str::contains($requestDomain, 'staging') ) {
            $subdomain.=".admin.";
        } else if(Str::contains($requestDomain, 'test')) {
            if(Str::contains($requestDomain, 'wholesales')) {
                $subdomain = "wholesales.admin.";
            } else if(Str::contains($requestDomain, 'supermarket')) {
    ...
    public static function parseDomain(string $requestDomain) : string
    {
        $domain = [
